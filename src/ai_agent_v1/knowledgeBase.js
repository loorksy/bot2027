...
const DEFAULT_KNOWLEDGE = [
    {
        id: 'salary_delay',
        category: 'الرواتب',
        keywords: ['تأخر', 'تاخر', 'متأخر', 'متاخر', 'ليش', 'لماذا', 'وين', 'راتب', 'الراتب'],
        question: 'لماذا تأخر الراتب؟',
        answer: 'نعمل حالياً على تسليم الرواتب لجميع العملاء. يمكنك متابعة حالة راتبك من صفحتك الشخصية، وسترى صورة الوصل هناك فور إتمام التحويل. وستصلك رسالة تأكيد عند وصول الوصل.',
        sendPortalLink: true,
        active: true
    },
    {
        ...
        answer: 'مبلغ الراتب يتم حسابه بناءً على أيام العمل والخصومات إن وجدت. يمكنك مراجعة تفاصيل راتبك كاملة من صفحتك الشخصية. إذا كان هناك خطأ، يرجى إرسال "طلب مراجعة" وسنتحقق من الأمر.',
        sendPortalLink: true,
        active: true
    },
    {
        id: 'receipt_status',
        category: 'الوصولات',
        keywords: ['وصل', 'وصول', 'إيصال', 'ايصال', 'تحويل', 'حوالة', 'صورة'],
        question: 'أين صورة الوصل/الحوالة؟',
        answer: 'صور الوصولات تُرفع مباشرة على صفحتك الشخصية. يمكنك الدخول لصفحتك ومشاهدة جميع الوصولات وتحميلها. عند رفع وصل جديد ستصلك رسالة تنبيه.',
        sendPortalLink: true,
        active: true
    },
    {
        ...
        answer: 'يمكنك تعديل بياناتك الأساسية (الاسم، الهاتف، العنوان) مباشرة من صفحتك الشخصية. إذا كنت تريد تعديل بيانات أخرى، أخبرني بالتفاصيل وسأساعدك.',
        sendPortalLink: true,
        active: true
    },
    {
